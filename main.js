...
var last_pos_Mouse_X;
var last_pos_Mouse_Y;
...
function mymousemove(e){
    ...
    if (mouseEvent=="mouseDown"){
        ...
        ctx.lineWidth=width_of_line;
        console.log("Last Position of X and Y Coordinates");
        console.log("X="+last_pos_Mouse_X+"Y="+ last_pos_Mouse_Y);
    ...
    last_pos_Mouse_X=cur_pos_MouseX;
    last_pos_Mouse_Y=cur_pos_MouseY;
}
}
